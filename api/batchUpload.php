...
//                 echo $emp->first_name, $emp->middle_name, $emp->last_name, $emp->suffix, $emp->nickname, $emp->salutation, $emp->contact_no, $emp->address, $emp->nationality, $emp->employee_id, $emp->company, $emp->department, $emp->team, $job_description, $employment_type, $contract_type, $hire_date, "", "", "";
//                 // array_push($status, $user->insertAcc($emp->first_name, $emp->middle_name, $emp->last_name, $emp->suffix, $emp->nickname, $emp->salutation, $emp->contact_no, $emp->address, $emp->nationality, $emp->employee_id, $emp->company, $emp->department, $emp->team, $job_description, $employment_type, $contract_type, $hire_date, "", "", "") ? 1 : 0);
//             }
//         }
//     }
