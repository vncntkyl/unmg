    ...
    <>
          <div className="fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] min-w-[90%] max-w-[90%] z-[26] bg-white rounded-md p-2 transition-all md:min-w-[70%] lg:min-w-[20%]">
            ...
            <div className="flex flex-col items-center">
              ...
              <label for="recommendation" className="text-[1.1rem] font-semibold pl-2">
                  Recommendations
                </label>
                <textarea
                  id="recommendation"
              ...
              <div className="py-2">
                <span>I confirm that the {full_name} grade for this work year is accurate and appropriate based on their performance over the past and their job responsibilities.</span>
              </div>
            </div>
            {/* FOOTER */}
