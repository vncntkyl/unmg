                  ...
                  convo.map((item_convo) => (
                    <div
                      ...
                      <div className="my-2 w-full max-w-lg">
                        <span className={classNames("opacity-0 group-hover:opacity-100 text-[0.75rem] flex gap-2", parseInt(item_convo.employee_id) === parseInt(employee_id) ? "justify-end" : "justify-start")}>
                          <span>
                            {format(
                            ...
                            {convo
                              ...
                              .map((con) => (
                                <div
                                  ...
                                  id={`reply_${con.ID}`}>
                                  {/* <ImForward /> */}
                                  <button>{con.message.length > 20 ? `${con.message.substring(0, 20)}...` : con.message}</button>
                                </div>
                              ))
                            }
                          </div>
