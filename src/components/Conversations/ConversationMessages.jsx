  ...
  return loading ? (
    ...
    <>
      <div className="w-full mt-4">
        <div className="border-t border-x bg-default border-default-dark rounded-t-md p-2 flex items-center gap-2">
          <button
        ...
        >
          ...
          <div className="flex justify-between text-[1rem]">
            <div className="flex flex-col">
              ...
              {convoSettings && (convoSettings.convo_type == "2" ? (<span>Quarter: {convoSettings.evaluaion_quarter == "1" ? "First Quarter" : convoSettings.evaluaion_quarter == "2" ? "Mid Year" : convoSettings.evaluaion_quarter == "3" ? "Third Quarter" : "Year End"}</span>) : "")}
              ...
              {convoSettings && (convoSettings.admin_access == "2" ? (<span className="text-un-red text-[0.8rem]">Please note that the contents of this conversation may be accessed by the administrator for monitoring purposes.</span>) : "")}
