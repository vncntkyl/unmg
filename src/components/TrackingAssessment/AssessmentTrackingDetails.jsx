    ...
    <>
      <div className="font-semibold text-dark-gray bg-default rounded-md p-2">
        ...
        {quarter == 1 ? (
          <>
            {ifResultsExists &&
              ifResultsExists.map((checkresult, resultIndex) => (
                <div key={resultIndex}>
                  {checkresult.checkfq === true ? (
                    ""
                  ) : (
                    <>
                      {ifAchievementsExists.map(
                        (checkAchievement, achievementIndex) => (
                          <div key={achievementIndex}>
                            {checkAchievement.fq_achievements === true ? (
                              <>
                                <div>
                                  <span className="w-full flex justify-center">
                                    Please wait for your supervisor to grade
                                    your KPI.
                                  </span>
                              ...
                              <>
                                <span className="flex justify-center py-2">
                                  You have not yet submitted your achievements
                                  for the {quarterName}.
                                </span>
                        ...
                        (checkAchievement, achievementIndex) => (
                          <div key={achievementIndex}>
                            {checkAchievement.myr_achievements === true ? (
                              ...
                              <>
                                {checkresult.checkfq === false &&
                                checkAchievement.fq_achievements === false ? (
                                  <span className="flex justify-center py-2">
                                    This quarter is still unavailable. Please
                                    submit achievements on the First Quarter
                                  </span>
                                ) : (
                                  <>
                                    <span className="flex justify-center py-2">
                                      You have not yet submitted your
                                      achievements for the {quarterName}.
                                    </span>
                                    <div className="flex justify-center py-2">
                                      <a
                                        href="/tracking_and_assessment/create"
                        ...
                        (checkAchievement, achievementIndex) => (
                          <div key={achievementIndex}>
                            {checkAchievement.tq_achievements === true ? (
                              ...
                              <>
                                {checkresult.checkmyr === false &&
                                checkAchievement.myr_achievements === false ? (
                                  <span className="flex justify-center py-2">
                                    This quarter is still unavailable. Please
                                    submit achievements on the Second Quarter
                                  </span>
                                ) : (
                                  <>
                                    <span className="flex justify-center py-2">
                        ...
                        (checkAchievement, achievementIndex) => (
                          <div key={achievementIndex}>
                            {checkAchievement.yee_achievements === true ? (
                              ...
                              <>
                                {checkresult.checktq === false &&
                                checkAchievement.tq_achievements === false ? (
                                  <span className="flex justify-center py-2">
                                    This quarter is still unavailable. Please
                                    submit achievements on the Third Quarter
                                  </span>
                                ) : (
                                  <>
                                    <span className="flex justify-center py-2">
