...
export default function Logs() {
    const rawData = [
        ...
        { ID: 21, employee_id: 1021, name: "Jane Smith", user_type: 6, action: 2, module_type: 4, logs_description: "Created new task", deleted: 0, creation_date: "2024-01-01 10:30:22" },
        { ID: 22, employee_id: 1022, name: "Bob Johnson", user_type: 2, action: 1, module_type: 2, logs_description: "Logged in to admin panel", deleted: 0, creation_date: "2024-01-02 15:45:11" },
        { ID: 23, employee_id: 1023, name: "Emily Davis", user_type: 6, action: 3, module_type: 1, logs_description: "Error fixing in payment processing", deleted: 0, creation_date: "2024-01-03 12:00:30" },
        { ID: 24, employee_id: 1024, name: "Mike Wilson", user_type: 6, action: 2, module_type: 5, logs_description: "Deleted obsolete records", deleted: 0, creation_date: "2024-01-04 14:20:05" },
        { ID: 25, employee_id: 1025, name: "Sophia Martinez", user_type: 6, action: 1, module_type: 3, logs_description: "Modified access permissions", deleted: 0, creation_date: "2024-01-05 09:05:12" },
        { ID: 26, employee_id: 1026, name: "William Taylor", user_type: 6, action: 3, module_type: 2, logs_description: "Reviewed quarterly reports", deleted: 0, creation_date: "2024-01-06 11:30:44" },
        { ID: 27, employee_id: 1027, name: "Olivia Anderson", user_type: 6, action: 2, module_type: 4, logs_description: "System update installed", deleted: 0, creation_date: "2024-01-07 13:40:19" },
        { ID: 28, employee_id: 1028, name: "James Clark", user_type: 6, action: 1, module_type: 1, logs_description: "Conducted training session", deleted: 0, creation_date: "2024-01-08 16:55:58" },
        { ID: 29, employee_id: 1029, name: "Emma Brown", user_type: 6, action: 2, module_type: 5, logs_description: "Performance optimization completed", deleted: 0, creation_date: "2024-01-09 08:00:37" },
        { ID: 30, employee_id: 1030, name: "Daniel Garcia", user_type: 6, action: 1, module_type: 3, logs_description: "Debugged backend issues", deleted: 0, creation_date: "2024-01-09 10:10:15" },
    ];
    ...
    useEffect(() => {
        const uniqueDates = [...new Set(rawData.map(rawData => format(new Date(rawData.creation_date), 'yyyy-MM-dd')))];
            ...
            {dates && dates.length > 0 ? (
                <>
                    <Accordion flush className="rounded-none shadow" collapseAll>
                        {dates.sort().reverse().map((headerDate, index) => (
                                ...
                                <Accordion.Content>
                                    <Timeline>
                                        {rawData
                                            ...
                                            .filter((contentDate) => isSameDay(new Date(contentDate.creation_date), new Date(headerDate)))
                                            .map((log) => (
