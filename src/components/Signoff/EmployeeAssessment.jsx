        ...
        <table className="bg-white w-full">
          <thead>
            <tr className="bg-un-blue-light text-white">
              ...
              <td className="px-10">Job Title</td>
              <td className="px-10">Supervisor</td>
              <td className="px-10">Immediate Supervisor</td>
              <td className="px-10">Next Immediate Supervisor</td>
                ...
                <tr key={employee.id}>
                  <td>
                    <div className="flex flex-row justify-start items-center gap-2">
                      <AiFillCheckCircle className="text-[#3D8F36]" />
                  ...
                  <td>
                    <div className="flex flex-row justify-start items-center gap-2">
                      <AiFillCheckCircle className="text-[#3D8F36]" />
                      {employee.primary_eval_name}
                    </div>
                  </td>
                  <td>
                    <div className="flex flex-row justify-start items-center gap-2">
                      <AiFillCheckCircle className="text-[#3D8F36]" />
                      {employee.secondary_eval_name}
                    </div>
                  </td>
                  <td>
                    <div className="flex flex-row justify-start items-center gap-2">
                      <AiFillCheckCircle className="text-[#3D8F36]" />
                      {employee.tertiary_eval_name}
                    </div>
                  </td>
                  <td>
                    <div className="text-[1.2 rem] flex flex-row justify-center items-center">
                      <CiCircleMore />
                    </div>
                  </td>
                </tr>
