...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2023 at 11:10 PM
...
--
-- Table structure for table `hr_convo_inbox`
--

CREATE TABLE `hr_convo_inbox` (
  `ID` int(11) NOT NULL,
  `convo_type` varchar(4) NOT NULL COMMENT '0 = Not Chosen\r\n1 = Planning\r\n2 = Evaluations\r\n3 = Directional/Redirectional\r\n4 = Coaching\r\n5 = PIP',
  `evaluation_quarter` int(1) DEFAULT NULL COMMENT '0 = Not Chosen\r\n1 = First Quarter\r\n2 = Mid Year\r\n3 = Third Year\r\n4 = Year End',
  `coaching_type` int(1) DEFAULT NULL COMMENT '0 = Not Chosen\r\n1 = Corrective\r\n2 = Developmental',
  `admin_access` int(1) NOT NULL COMMENT '1 = No\r\n2 = Yes',
...
--
-- Dumping data for table `hr_convo_inbox`
--

INSERT INTO `hr_convo_inbox` (`ID`, `convo_type`, `evaluation_quarter`, `coaching_type`, `admin_access`, `agenda`, `last_sent_message`, `last_sent_user_id`, `deleted`, `last_modified`, `creation_date`) VALUES
(1, '1', 0, 0, 2, 'hellooo', 'fskl;djfsflksdfjskldjfklklsjfkls', 23052906, 0, '2023-12-06 13:53:17', '2023-12-06 09:34:28'),
(2, '2', 2, 0, 2, 'hellooo', 'I have a question about my results for the mid year quarter', 23052906, 0, '2023-12-06 13:53:20', '2023-12-06 09:44:00'),
(3, '4', 0, 2, 2, 'hellooo', 'Paturo po ako sir', 23052906, 0, '2023-12-06 13:53:21', '2023-12-06 10:08:04'),
(4, '1', 0, 0, 2, 'Conversation Tab', 'Sir Patapos na po ang planning conversations ko.', 23052906, 0, '2023-12-06 13:57:21', '2023-12-06 13:57:21'),
(5, '3', 0, 0, 0, 'asdasdasda', 'asdasdasdasdasd', 23052906, 0, '2023-12-06 17:04:32', '2023-12-06 17:04:32');

-- --------------------------------------------------------

--
-- Table structure for table `hr_convo_messages`
--

CREATE TABLE `hr_convo_messages` (
  `ID` int(11) NOT NULL,
...
--
-- Dumping data for table `hr_convo_messages`
--

INSERT INTO `hr_convo_messages` (`ID`, `inbox_id`, `employee_id`, `message`, `creation_date`) VALUES
(1, 1, 23052906, 'fskl;djfsflksdfjskldjfklklsjfkls', '2023-12-06 09:34:28'),
(2, 2, 23052906, 'I have a question about my results for the mid year quarter', '2023-12-06 09:44:00'),
(3, 3, 23052906, 'Paturo po ako sir', '2023-12-06 10:08:04'),
(4, 4, 23052906, 'Sir Patapos na po ang planning conversations ko.', '2023-12-06 13:57:21'),
(5, 5, 23052906, 'asdasdasdasdasd', '2023-12-06 17:04:32');

-- --------------------------------------------------------

--
-- Table structure for table `hr_convo_participants`
--

CREATE TABLE `hr_convo_participants` (
  `ID` int(11) NOT NULL,
  `inbox_id` int(11) NOT NULL,
  `employee_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `hr_convo_participants`
--

INSERT INTO `hr_convo_participants` (`ID`, `inbox_id`, `employee_id`) VALUES
(1, 1, 23052906),
(2, 1, 22081701),
(3, 2, 23052906),
(4, 2, 22081701),
...
CREATE TABLE `hr_eval_form` (
  ...
  `myr_rater_1` int(11) DEFAULT NULL,
  `myr_rater_2` int(11) DEFAULT NULL,
  `myr_rater_3` int(11) DEFAULT NULL,
  `yee_rater_1` int(11) NOT NULL,
  `yee_rater_2` int(11) NOT NULL,
  `yee_rater_3` int(11) NOT NULL,
...
(1, 19, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1);
...
(1, 'xczxczczxczxc', 'fdfdfdfdfdf', 0.00, '', '0000-00-00', 1, 1),
(2, 'asdasdasdsd', '', 0.00, '', '0000-00-00', 2, 1),
(3, 'adasda', '', 0.00, '', '0000-00-00', 3, 1),
(4, 'sfgsdsfs', '', 0.00, '', '0000-00-00', 4, 1),
(5, 'sdfsdfs', '', 0.00, '', '0000-00-00', 5, 1),
(6, 'sdfsfdsdf', '', 0.00, '', '0000-00-00', 6, 1),
(7, 'asdasdasd', '', 0.00, '', '0000-00-00', 7, 1),
(8, 'asdadsasd', '', 0.00, '', '0000-00-00', 8, 1),
(9, 'asdadasda', '', 0.00, '', '0000-00-00', 9, 1),
(10, 'asdasdads', '', 0.00, '', '0000-00-00', 10, 1),
(11, 'asdasdasdasd', '', 0.00, '', '0000-00-00', 11, 1),
(12, 'aasdasdasdasda', '', 0.00, '', '0000-00-00', 12, 1);
...
(1, 'sdgsdf', 'asdadadasd', '4', '', '0000-00-00', 1, 1),
(2, 'sdfsfsdfsdf', '', '4', '', '0000-00-00', 2, 1),
(3, 'sdfsdfsdf', '', '4', '', '0000-00-00', 3, 1),
(4, 'sdfsdfsfdsd', '', '4', '', '0000-00-00', 4, 1),
(5, 'sdfsdfsdfs', '', '4', '', '0000-00-00', 5, 1),
(6, 'sdfsfdsdf', '', '2', '', '0000-00-00', 6, 1),
(7, 'sdfsfdsfdsdf', '', '2', '', '0000-00-00', 7, 1),
(8, 'sdfsdfsdfsdf', '', '1', '', '0000-00-00', 8, 1),
(9, 'sdfsfdsdfs', '', '1', '', '0000-00-00', 9, 1),
(10, 'sdfsdfsdf', '', '2', '', '0000-00-00', 10, 1),
(11, 'sdfsdfsdfsdf', '', '3', '', '0000-00-00', 11, 1),
(12, 'dfsfsfdsfsdfsdf', '', '2', '', '0000-00-00', 12, 1);
...
(1, 'dsfsfdsfsfdfff', '', '', '0000-00-00', 1, 1),
(2, 'sdfsfsfsfsdfsdfs', '', '', '0000-00-00', 2, 1),
(3, 'sdfsdfsfsfsdfsdfsfsdfsdf', '', '', '0000-00-00', 3, 1),
(4, 'sdfsdfsdfsfdsdf', '', '', '0000-00-00', 4, 1),
(5, 'cvdvsdfsdfsdfs', '', '', '0000-00-00', 5, 1),
(6, 'sasdsdassdfsdf', '', '', '0000-00-00', 6, 1),
(7, 'sdfsfsfdsfsfsdfsdf', '', '', '0000-00-00', 7, 1),
(8, 'vxcvxvxvxc', '', '', '0000-00-00', 8, 1),
(9, 'xcvxvxvxvvxvc', '', '', '0000-00-00', 9, 1),
(10, 'xcvxvcvxcvxvc', '', '', '0000-00-00', 10, 1),
(11, 'xcvvxcvxvcvxv', '', '', '0000-00-00', 11, 1),
(12, 'cvxcvxxcvxcv', '', '', '0000-00-00', 12, 1);
...
(1, '', 'asdadasd', 'asdadasd', 3, '0.30', '0000-00-00', 1, 1),
(2, '', 'asdasdasd', 'asdasd', 4, '0.40', '0000-00-00', 2, 1),
(3, '', 'asdasd', '', 4, '0.40', '0000-00-00', 3, 1),
(4, '', '', '', 4, '0.40', '0000-00-00', 4, 1),
(5, '', '', '', 3, '0.15', '0000-00-00', 5, 1),
(6, '', '', '', 2, '0.40', '0000-00-00', 6, 1),
(7, '', '', '', 3, '0.30', '0000-00-00', 7, 1),
(8, '', '', '', 4, '0.20', '0000-00-00', 8, 1),
(9, '', '', '', 2, '0.10', '0000-00-00', 9, 1),
(10, '', '', '', 3, '0.15', '0000-00-00', 10, 1),
(11, '', '', '', 2, '0.10', '0000-00-00', 11, 1),
(12, '', '', '', 2, '0.10', '0000-00-00', 12, 1);

-- --------------------------------------------------------

--
-- Table structure for table `hr_global_settings`
--

CREATE TABLE `hr_global_settings` (
  `ID` int(11) NOT NULL,
  `pillar_min` int(11) NOT NULL,
  `pillar_max` int(11) NOT NULL,
  `required_min` int(11) NOT NULL,
  `required_max` int(11) NOT NULL,
  `overall_percentage` int(11) NOT NULL,
  `goal_status` int(1) NOT NULL COMMENT '1 = unlocked\r\n2 = locked'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `hr_global_settings`
--

INSERT INTO `hr_global_settings` (`ID`, `pillar_min`, `pillar_max`, `required_min`, `required_max`, `overall_percentage`, `goal_status`) VALUES
(1, 10, 15, 1, 2, 100, 0);
...
(15, 22111602, NULL, NULL, 'Ramos', 'Lorraine Ann', '.', NULL, 'Raine', 1, 1, 'Information Systems & Technology Integration', 'Web Developer', 'regular', '09991113498', 'Makati, Philippines', 21020804, NULL, NULL, 'LOCAL', 'Filipino', '2023-05-29', NULL, NULL),
...
(1, 1, 'admin', '0192023a7bbd73250516f069df18b500', 'admin@admin.com', 1, 'active', 'active'),
(2, 10, 'rater1', '0192023a7bbd73250516f069df18b500', 'christopher.leynes@unitedneon.com', 6, 'active', 'active'),
(3, 11, 'rater2', '0192023a7bbd73250516f069df18b500', 'jobert.lim@unitedneon.com', 6, 'active', 'active'),
...
(6, 14, 'rater3', '0192023a7bbd73250516f069df18b500', 'michael.ramilo@unitedneon.com', 4, 'active', 'active'),
...
--
-- Indexes for table `hr_convo_inbox`
--
ALTER TABLE `hr_convo_inbox`
  ADD PRIMARY KEY (`ID`);

--
-- Indexes for table `hr_convo_messages`
--
ALTER TABLE `hr_convo_messages`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `employee_id` (`employee_id`),
  ADD KEY `inbox_id` (`inbox_id`);

--
-- Indexes for table `hr_convo_participants`
--
ALTER TABLE `hr_convo_participants`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `inbox_id` (`inbox_id`),
  ADD KEY `hr_convo_participants_ibfk_1` (`employee_id`);
...
--
-- Indexes for table `hr_global_settings`
--
ALTER TABLE `hr_global_settings`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `hr_convo_inbox`
--
ALTER TABLE `hr_convo_inbox`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `hr_convo_messages`
--
ALTER TABLE `hr_convo_messages`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `hr_convo_participants`
--
ALTER TABLE `hr_convo_participants`
...
--
ALTER TABLE `hr_eval_form`
  MODIFY `hr_eval_form_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `hr_eval_form_pillars`
  MODIFY `hr_eval_form_pillar_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
-- AUTO_INCREMENT for table `hr_global_settings`
--
ALTER TABLE `hr_global_settings`
...
--
-- Constraints for table `hr_convo_messages`
--
ALTER TABLE `hr_convo_messages`
  ADD CONSTRAINT `hr_convo_messages_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `hr_users` (`employee_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `hr_convo_messages_ibfk_2` FOREIGN KEY (`inbox_id`) REFERENCES `hr_convo_inbox` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `hr_convo_participants`
--
ALTER TABLE `hr_convo_participants`
  ADD CONSTRAINT `hr_convo_participants_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `hr_users` (`employee_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `hr_convo_participants_ibfk_2` FOREIGN KEY (`inbox_id`) REFERENCES `hr_convo_inbox` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;
